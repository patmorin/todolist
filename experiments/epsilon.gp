...
plot 'epsilon-find.dat' using 7:4 with linespoints linestyle 1 title 'search time', 'epsilon-add.dat' using 7:4 axes x1y2 with linespoints linestyle 2 title 'construction time'
#    EOF
