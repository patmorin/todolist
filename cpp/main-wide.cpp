/* This is a near-duplicate of main.cpp that has been modified to make
 * sizeof(Integer) = 16 bytes. This was to test a theory of a SODA referee
 * that larger keys would mean that todolists don't get the benefits of
 * cache-coherence that smaller (4 byte) keys do.
 */
#include <cstdlib>
#include <cstdio>
#include <iostream>
