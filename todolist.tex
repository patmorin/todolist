...
that todolists do behave as \thmref{todolist} predicts.  Insertion time
...
\begin{figure}
  ...
  \centering{\input{e2/epsilon.tex}}
...
\begin{figure}
  %\resizebox{\tmpa}{!}{\input{images/bigoh-1.tex}}\\[4ex]
  \centering{\input{e2/bigtest-find.tex}}
...
\begin{figure}
  %\resizebox{\tmpa}{!}{\input{images/bigoh-1.tex}}\\[4ex]
  \centering{\input{e2/bigtest-add.tex}}
